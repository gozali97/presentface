...
2\. Model AI yang Digunakan di Project Ini (buffalo\_l)

Saat sistem berjalan, InsightFace menggunakan paket model

canggih bernama buffalo\_l yang terdiri dari:

1\. RetinaFace (det\_10g.onnx)
...
│ Perbandingan │ (face\_recognition / │ (Project Ini) │
